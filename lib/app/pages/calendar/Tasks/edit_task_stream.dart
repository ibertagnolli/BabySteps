    ...
    if (reminderType == 3) {
      ...
      if (reminderType == 1) {
        ...
        if (timeUnit == "minutes") {
          ...
          reminderDT =
              DateTime(now.year, now.month, now.day, hours, now.minute);
        } else {
          // days
          int days = now.day + timeInterval;
          reminderDT =
              DateTime(now.year, now.month, days, now.hour, now.minute);
        }
      }
      // remind "at" certain time
        ...
        List<String> splitTime =
            timeController.text.split(' '); // format 2:00 PM
        ...
        reminderDT = DateTime(reminderDate.year, reminderDate.month,
      ...
      if (DateTime.now().isBefore(reminderDT)) {
        NotificationService().scheduleNotification(
            ...
            body: DateFormat("h:mma").format(reminderDT),
      ...
      uploaddata = {
        ...
        'dateTime': reminderDT,
        'timeLength': (howManyController.text.isNotEmpty)
            ? int.parse(howManyController.text)
            : -1,
          ...
          return IconButton(
            ...
            onPressed: () {
              ...
              if (data['reminderType'] == "in") {
                ...
                TimeOfDay initTimeOfDay = TimeOfDay(
                    hour: reminderDate.hour, minute: reminderDate.minute);
